...
import Resubmit_IN.Step02_ResubmitRequest_IN;
...
public class ResubmitRequest_IN
{
	// TestNG logger
...
//		driver = new ChromeDriver();
	...
	public void RIPC_Login() throws InterruptedException 
	{
		...
		Step02_ResubmitRequest_IN login = new Step02_ResubmitRequest_IN(driver);
		login.login();
	}
	@Test(priority=1)
	public void modifyRequestdetails() 
	{
		...
		Step02_ResubmitRequest_IN modifyreq_details = new Step02_ResubmitRequest_IN(driver);
	...
	{
		Step02_ResubmitRequest_IN modifyreq_info = new Step02_ResubmitRequest_IN(driver);
