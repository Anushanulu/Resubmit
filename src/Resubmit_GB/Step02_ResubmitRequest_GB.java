...
public class Step02_ResubmitRequest_GB {
	...
	@FindBy(xpath = ".//h3[contains(text(),'Supplier warning' )]")
	private WebElement SuppWarning_header;
	@FindBy(id = "FLD_SUPPWARN_SUPPSELJUST")
	private WebElement SuppWarning_msg;
	...
	public Step02_ResubmitRequest_GB(WebDriver driver) {
		this.driver = driver;
