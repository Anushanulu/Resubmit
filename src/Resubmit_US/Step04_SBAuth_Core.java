...
import Resubmit_GB.Step04_SBActions_Core_GB;
import lib.Excel;
...
public class Step04_SBAuth_Core {
...
public Step04_SBAuth_Core(WebDriver driver)
{
	this.driver=driver;
...
public void SB_Auth_req ()
{
	...
	Step04_SBAuth_Core popup = new Step04_SBAuth_Core(driver);
